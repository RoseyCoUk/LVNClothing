...
const productData = {
  ...
  defaultVariant: 501, // The ID of the single, default variant
  variantDetails: {
...
interface WaterBottlePageProps {
  onBack: () => void;
}
...
const WaterBottlePage = ({ onBack }: WaterBottlePageProps) => {
  ...
  const reviews = [
    { id: 1, name: "Chris P.", rating: 5, date: "1 week ago", comment: "Excellent insulation, keeps my coffee hot all morning!", verified: true },
    { id: 2, name: "Helen R.", rating: 5, date: "2 weeks ago", comment: "Great quality bottle, no leaks and the logo looks fantastic.", verified: true },
    { id: 3, name: "Paul M.", rating: 5, date: "3 weeks ago", comment: "Perfect size for the gym, keeps water ice cold.", verified: true }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            {/* Color Display */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">Color: <span className="font-semibold text-gray-900">{currentVariant.color}</span></label>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                <p className="text-gray-800 font-medium">500ml (16.9 fl oz)</p>
              </div>
            </div>
