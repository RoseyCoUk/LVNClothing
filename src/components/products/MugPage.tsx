...
const productData = {
  ...
  description: "High-quality ceramic mug featuring the LVN Clothing logo and 'Let's Make Britain Great Again' message. Perfect for your morning coffee or tea.",
