...
const productData = {
  ...
  description: "High-quality mouse pad with LVN Clothing design. Features a smooth surface for precise mouse tracking and non-slip rubber base.",
  features: ["Smooth tracking surface", "Non-slip rubber base", "Fade-resistant printing", "Easy to clean", "Standard size", "Durable construction"],
...
const MousePadPage = ({ onBack }: MousePadPageProps) => {
  ...
  const reviews = [
    { id: 1, name: "Alex P.", rating: 5, date: "1 week ago", comment: "Great mouse pad, smooth surface and stays in place perfectly!", verified: true },
    { id: 2, name: "Jenny M.", rating: 4, date: "2 weeks ago", comment: "Good quality, nice design. Works well for gaming and work.", verified: true },
    { id: 3, name: "Steve R.", rating: 4, date: "3 weeks ago", comment: "Solid mouse pad, good value for money.", verified: true }
  ];
          ...
          <div className="space-y-6">
            ...
            <div>
                ...
                <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                  <p className="text-gray-800 font-medium">Standard</p>
                </div>
            </div>
