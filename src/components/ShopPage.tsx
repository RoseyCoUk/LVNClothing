...
const gearProducts = [
  ...
  { id: 6, name: "Reform UK Mug", price: 12.99, image: "StickerToteWater/ReformMug1.webp", hoverImage: "StickerToteWater/ReformMug5.webp", rating: 4, reviews: 156, category: 'gear', tags: ['bestseller'], shipping: "Ships in 24H", description: "Ceramic coffee mug", dateAdded: '2025-05-10' },
