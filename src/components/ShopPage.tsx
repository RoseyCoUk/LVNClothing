...
const gearProducts = [
  { id: 4, name: "Reform UK Tote Bag", price: 16.99, image: "ReformToteBagBlack1.webp", hoverImage: "ReformToteBagBlack2.webp", rating: 4, reviews: 156, category: 'gear', tags: [], shipping: "Ships in 24H", description: "Durable tote bag", dateAdded: '2025-06-20' },
  { id: 5, name: "Reform UK Water Bottle", price: 18.99, image: "ReformWaterBottleWhite1.webp", hoverImage: "ReformWaterBottleWhite2.webp", rating: 5, reviews: 203, category: 'gear', tags: ['new'], shipping: "Ships in 24H", description: "Insulated water bottle", dateAdded: '2025-07-02' },
  { id: 6, name: "Reform UK Mug", price: 12.99, image: "/ReformMug1.png", hoverImage: "/ReformMug2.png", rating: 4, reviews: 156, category: 'gear', tags: ['bestseller'], shipping: "Ships in 24H", description: "Ceramic coffee mug", dateAdded: '2025-05-10' },
  { id: 7, name: "Reform UK Mouse Pad", price: 14.99, image: "ReformMousePadWhite1.webp", hoverImage: "ReformMousePadWhite2.webp", rating: 4, reviews: 78, category: 'gear', tags: [], shipping: "Ships in 24H", description: "High-quality mouse pad", dateAdded: '2025-06-25' },
  { id: 8, name: "Reform UK Stickers", price: 6.99, image: "ReformStickersMain1.webp", hoverImage: "ReformStickersMain2.webp", rating: 5, reviews: 234, category: 'gear', tags: ['bestseller'], shipping: "Ships in 24H", description: "Weatherproof sticker set", dateAdded: '2025-05-01' },
