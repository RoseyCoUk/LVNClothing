...
const gearProducts = [
  { id: 4, name: "Reform UK Tote Bag", price: 19.99, image: "StickerToteWater/ReformToteBagBlack1.webp", hoverImage: "StickerToteWater/ReformToteBagBlack2.webp", rating: 4, reviews: 156, category: 'gear', tags: [], shipping: "Ships in 24H", description: "Durable tote bag", dateAdded: '2025-06-20' },
  { id: 5, name: "Reform UK Water Bottle", price: 24.99, image: "StickerToteWater/ReformWaterBottleWhite1.webp", hoverImage: "StickerToteWater/ReformWaterBottleWhite2.webp", rating: 5, reviews: 203, category: 'gear', tags: ['new'], shipping: "Ships in 24H", description: "Insulated water bottle", dateAdded: '2025-07-02' },
  { id: 6, name: "Reform UK Mug", price: 19.99, image: "MugMouse/ReformMug1.webp", hoverImage: "MugMouse/ReformMug5.webp", rating: 4, reviews: 156, category: 'gear', tags: ['bestseller'], shipping: "Ships in 24H", description: "Ceramic coffee mug", dateAdded: '2025-05-10' },
  ...
  { id: 8, name: "Reform UK Stickers", price: 9.99, image: "StickerToteWater/ReformStickersMain2.webp", hoverImage: "StickerToteWater/ReformStickersMain3.webp", rating: 5, reviews: 234, category: 'gear', tags: ['bestseller'], shipping: "Ships in 24H", description: "Weatherproof sticker set", dateAdded: '2025-05-01' },
