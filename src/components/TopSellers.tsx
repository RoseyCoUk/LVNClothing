...
const TopSellers = ({ onProductClick }: TopSellersProps) => {
    ...
    <section id="top-sellers" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mt-8">
          <button className="bg-gray-900 hover:bg-gray-800 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-200 flex items-center space-x-2 mx-auto">
