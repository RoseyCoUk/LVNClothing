...
async def run_test():
    ...
    try:
        ...
        # Clear email input and enter a valid email address, then input password and click 'Sign in'.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/main/div/div/form/div/div/div/input').nth(0)
        ...
        # Click on the 'Back Reform' button (index 0) to access account settings or privacy page.
        frame = context.pages[-1]
