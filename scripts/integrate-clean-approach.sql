-- Integrate Admin Products System with Existing Products Table (CLEAN APPROACH)
...
-- STEP 12: Migrate existing product images to the new structure
...
-- STEP 14: Show final products table structure
SELECT 
