-- Integrate Admin Products System with Existing Products Table (SIMPLE WORKING VERSION)
-- This script creates everything in the correct order with proper foreign keys
...
-- STEP 3: Create product_overrides table with foreign key
...
-- STEP 4: Create product_images table with foreign key
...
-- STEP 6: Create bundle_items table with foreign keys
...
-- STEP 7: Create sync_status table with foreign key
...
SELECT 'Integration Complete!' as status, 'All tables created successfully' as detail;
