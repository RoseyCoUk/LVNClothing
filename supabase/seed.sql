...
-- Note: Products are now inserted by migrations, so this file is kept for reference only
...
--   (gen_random_uuid(), 'Starter Bundle', 'Starter bundle with T-shirt, cap, and mug', 34.99, 'bundle', ARRAY['bundle'], '/Tshirt/Men/ReformMenTshirtCharcoal1.webp', 'starter-bundle', 5, 10, now(), now()),
