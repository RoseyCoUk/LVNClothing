-- Add test products with printful_product_id values for testing sync functionality
-- NOTE: These are inserted for testing but then deleted to ensure clean slate

-- Insert test products with real Printful IDs from your store
...
-- PHASE 1 CLEAN SLATE: Delete all test products to ensure clean database
-- This ensures we start with 0 products for the Printful import
